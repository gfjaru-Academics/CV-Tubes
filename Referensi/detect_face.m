...
img=imread('100.jpg'); %Read input image
...
for i=1:N
    ...
    savenam = strcat('D:\Kampus\Materi\TINGKAT 3\SEMESTER 6\Komvis\Detect face' ,num2str(counter), '.jpg'); %this is where and what your image will be saved
    baseDir  = 'D:\Kampus\Materi\TINGKAT 3\SEMESTER 6\Komvis\Detect face\TestDatabase\';
    %     baseName = 'image_';
